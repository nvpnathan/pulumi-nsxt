        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (this.provider.read) {
                    ...
                    const result = yield this.provider.read(id, props);
                    resp.setId(result.id);
    ...
    construct(call, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                runtime.setConstructOptions(req.getProject(), req.getStack(), req.getParallel(), this.engineAddr, req.getMonitorendpoint(), req.getDryrun());
                const pulumiConfig = {};
