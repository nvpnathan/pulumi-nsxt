...
export declare type OutputResolvers = Record<string, (value: any, isStable: boolean, isSecret: boolean, deps?: Resource[]) => void>;
/**
 ...
 */
export declare function resolveProperties(res: Resource, resolvers: Record<string, (v: any, isKnown: boolean, isSecret: boolean, deps?: Resource[]) => void>, t: string, name: string, allProps: any, deps: Record<string, Resource[]>): void;
/**
