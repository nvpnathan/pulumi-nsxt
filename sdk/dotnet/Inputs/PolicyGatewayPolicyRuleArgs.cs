...
namespace Pulumi.Nsxt.Inputs
{
    ...
    public sealed class PolicyGatewayPolicyRuleArgs : Pulumi.ResourceArgs
    {
        [Input("action")]
        ...
        [Input("tags")]
        private InputList<Inputs.PolicyGatewayPolicyRuleTagArgs>? _tags;
        public InputList<Inputs.PolicyGatewayPolicyRuleTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.PolicyGatewayPolicyRuleTagArgs>());
            set => _tags = value;
        }

        public PolicyGatewayPolicyRuleArgs()
        {
        }
    }
}
