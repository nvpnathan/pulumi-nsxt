...
namespace Pulumi.Nsxt.Inputs
{
    ...
    public sealed class PolicyGatewayPolicyRuleGetArgs : Pulumi.ResourceArgs
    {
        [Input("action")]
        ...
        [Input("tags")]
        private InputList<Inputs.PolicyGatewayPolicyRuleTagGetArgs>? _tags;
        public InputList<Inputs.PolicyGatewayPolicyRuleTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.PolicyGatewayPolicyRuleTagGetArgs>());
            set => _tags = value;
        }

        public PolicyGatewayPolicyRuleGetArgs()
        {
        }
    }
}
