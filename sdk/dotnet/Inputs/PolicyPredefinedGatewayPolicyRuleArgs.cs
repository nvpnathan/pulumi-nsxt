...
namespace Pulumi.Nsxt.Inputs
{
    ...
    public sealed class PolicyPredefinedGatewayPolicyRuleArgs : Pulumi.ResourceArgs
    {
        [Input("action")]
        ...
        [Input("tags")]
        private InputList<Inputs.PolicyPredefinedGatewayPolicyRuleTagArgs>? _tags;
        public InputList<Inputs.PolicyPredefinedGatewayPolicyRuleTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.PolicyPredefinedGatewayPolicyRuleTagArgs>());
            set => _tags = value;
        }

        public PolicyPredefinedGatewayPolicyRuleArgs()
        {
        }
    }
}
