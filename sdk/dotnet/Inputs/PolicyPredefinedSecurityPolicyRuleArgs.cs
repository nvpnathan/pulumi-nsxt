...
namespace Pulumi.Nsxt.Inputs
{
    ...
    public sealed class PolicyPredefinedSecurityPolicyRuleArgs : Pulumi.ResourceArgs
    {
        [Input("action")]
        ...
        [Input("tags")]
        private InputList<Inputs.PolicyPredefinedSecurityPolicyRuleTagArgs>? _tags;
        public InputList<Inputs.PolicyPredefinedSecurityPolicyRuleTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.PolicyPredefinedSecurityPolicyRuleTagArgs>());
            set => _tags = value;
        }

        public PolicyPredefinedSecurityPolicyRuleArgs()
        {
        }
    }
}
