...
namespace Pulumi.Nsxt.Inputs
{
    ...
    public sealed class PolicyPredefinedSecurityPolicyRuleGetArgs : Pulumi.ResourceArgs
    {
        [Input("action")]
        ...
        [Input("tags")]
        private InputList<Inputs.PolicyPredefinedSecurityPolicyRuleTagGetArgs>? _tags;
        public InputList<Inputs.PolicyPredefinedSecurityPolicyRuleTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.PolicyPredefinedSecurityPolicyRuleTagGetArgs>());
            set => _tags = value;
        }

        public PolicyPredefinedSecurityPolicyRuleGetArgs()
        {
        }
    }
}
