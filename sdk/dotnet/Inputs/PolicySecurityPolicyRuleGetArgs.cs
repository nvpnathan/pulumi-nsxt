...
namespace Pulumi.Nsxt.Inputs
{
    ...
    public sealed class PolicySecurityPolicyRuleGetArgs : Pulumi.ResourceArgs
    {
        [Input("action")]
        ...
        [Input("tags")]
        private InputList<Inputs.PolicySecurityPolicyRuleTagGetArgs>? _tags;
        public InputList<Inputs.PolicySecurityPolicyRuleTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.PolicySecurityPolicyRuleTagGetArgs>());
            set => _tags = value;
        }

        public PolicySecurityPolicyRuleGetArgs()
        {
        }
    }
}
