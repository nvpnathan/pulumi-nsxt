...
namespace Pulumi.Nsxt.Inputs
{
    ...
    public sealed class PolicySegmentSubnetDhcpV6ConfigArgs : Pulumi.ResourceArgs
    {
        [Input("dnsServers")]
        ...
        private InputList<Inputs.PolicySegmentSubnetDhcpV6ConfigExcludedRangeArgs>? _excludedRanges;
        public InputList<Inputs.PolicySegmentSubnetDhcpV6ConfigExcludedRangeArgs> ExcludedRanges
        {
            get => _excludedRanges ?? (_excludedRanges = new InputList<Inputs.PolicySegmentSubnetDhcpV6ConfigExcludedRangeArgs>());
        ...
        public PolicySegmentSubnetDhcpV6ConfigArgs()
        {
        }
    }
}
