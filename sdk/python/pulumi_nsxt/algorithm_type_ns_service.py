...
class AlgorithmTypeNSService(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, algorithm=None, description=None, destination_port=None, display_name=None, source_ports=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a AlgorithmTypeNSService resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] destination_port: A single destination port
        :param pulumi.Input[str] display_name: The display name of this resource. Defaults to ID if not set
        :param pulumi.Input[list] source_ports: Set of source ports or ranges
        ...
        super(AlgorithmTypeNSService, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, algorithm=None, default_service=None, description=None, destination_port=None, display_name=None, revision=None, source_ports=None, tags=None):
        """
        ...
        __props__["source_ports"] = source_ports
        __props__["tags"] = tags
        return AlgorithmTypeNSService(resource_name, opts=opts, __props__=__props__)
