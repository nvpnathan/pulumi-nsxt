...
class IGMPTypeNSService(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a IGMPTypeNSService resource with the given unique name, props, and options.
        ...
        super(IGMPTypeNSService, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, default_service=None, description=None, display_name=None, revision=None, tags=None):
        """
        ...
        __props__["tags"] = tags
        return IGMPTypeNSService(resource_name, opts=opts, __props__=__props__)
