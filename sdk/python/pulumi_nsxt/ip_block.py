...
class IPBlock(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, cidr=None, description=None, display_name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, cidr=None, description=None, display_name=None, revision=None, tags=None):
        """
