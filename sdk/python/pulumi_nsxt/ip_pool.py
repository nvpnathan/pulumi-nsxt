...
class IPPool(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, subnets=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a IPPool resource with the given unique name, props, and options.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, description=None, display_name=None, revision=None, subnets=None, tags=None):
        """
