...
class IPProtocolNSService(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, protocol=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a IPProtocolNSService resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[float] protocol: IP protocol number
        ...
        super(IPProtocolNSService, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, default_service=None, description=None, display_name=None, protocol=None, revision=None, tags=None):
        """
        ...
        __props__["tags"] = tags
        return IPProtocolNSService(resource_name, opts=opts, __props__=__props__)
