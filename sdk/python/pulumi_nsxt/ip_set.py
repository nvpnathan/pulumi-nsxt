...
class IPSet(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, ip_addresses=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] ip_addresses: Set of IP addresses
    ...
    @staticmethod
    def get(resource_name, id, opts=None, description=None, display_name=None, ip_addresses=None, revision=None, tags=None):
        """
