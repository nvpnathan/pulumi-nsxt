...
class LBServerSSLProfile(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, ciphers=None, description=None, display_name=None, protocols=None, session_cache_enabled=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a LBServerSSLProfile resource with the given unique name, props, and options.
        ...
        super(LBServerSSLProfile, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, ciphers=None, description=None, display_name=None, is_secure=None, protocols=None, revision=None, session_cache_enabled=None, tags=None):
        """
        ...
        __props__["session_cache_enabled"] = session_cache_enabled
        __props__["tags"] = tags
        return LBServerSSLProfile(resource_name, opts=opts, __props__=__props__)
