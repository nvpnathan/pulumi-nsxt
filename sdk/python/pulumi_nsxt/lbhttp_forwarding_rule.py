...
class LBHTTPForwardingRule(pulumi.CustomResource):
    ...
    Rule condition based on http header
      ...
      * `value` (`str`)
    """
    http_redirect_action: pulumi.Output[dict]
    """
    Redirect the request with a defined status and url
      ...
      * `redirectUrl` (`str`)
    """
    http_reject_action: pulumi.Output[dict]
    """
    ...
    """
    select_pool_action: pulumi.Output[dict]
    """
    ...
    Rule condition based on http request version
      ...
      * `version` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, body_conditions=None, cookie_conditions=None, description=None, display_name=None, header_conditions=None, http_redirect_action=None, http_reject_action=None, ip_conditions=None, match_strategy=None, method_conditions=None, select_pool_action=None, tags=None, tcp_conditions=None, uri_conditions=None, version_condition=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a LBHTTPForwardingRule resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[dict] http_redirect_action: Redirect the request with a defined status and url
        :param pulumi.Input[dict] http_reject_action: Reject the request with a defined status and message
        ...
        :param pulumi.Input[dict] select_pool_action: Forward the request to the a defined pool
        ...
        The **http_redirect_action** object supports the following:

          * `redirectStatus` (`pulumi.Input[str]`)
          * `redirectUrl` (`pulumi.Input[str]`)

        The **http_reject_action** object supports the following:

          * `replyMessage` (`pulumi.Input[str]`)
          * `replyStatus` (`pulumi.Input[str]`)
        ...
        The **select_pool_action** object supports the following:
        ...
        if opts.id is None:
            ...
            __props__['http_redirect_action'] = http_redirect_action
            __props__['http_reject_action'] = http_reject_action
            ...
            __props__['select_pool_action'] = select_pool_action
            __props__['tags'] = tags
        ...
        super(LBHTTPForwardingRule, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, body_conditions=None, cookie_conditions=None, description=None, display_name=None, header_conditions=None, http_redirect_action=None, http_reject_action=None, ip_conditions=None, match_strategy=None, method_conditions=None, revision=None, select_pool_action=None, tags=None, tcp_conditions=None, uri_conditions=None, version_condition=None):
        """
        ...
        __props__["uri_conditions"] = uri_conditions
        __props__["version_condition"] = version_condition
        return LBHTTPForwardingRule(resource_name, opts=opts, __props__=__props__)
