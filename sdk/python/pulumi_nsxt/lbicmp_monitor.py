...
class LBICMPMonitor(pulumi.CustomResource):
    data_length: pulumi.Output[float]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, data_length=None, description=None, display_name=None, fall_count=None, interval=None, monitor_port=None, rise_count=None, tags=None, timeout=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a LBICMPMonitor resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[float] data_length: The data size (in bytes) of the ICMP healthcheck packet
        ...
        if opts.id is None:
            ...
            __props__['data_length'] = data_length
        ...
        super(LBICMPMonitor, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, data_length=None, description=None, display_name=None, fall_count=None, interval=None, monitor_port=None, revision=None, rise_count=None, tags=None, timeout=None):
        """
        ...
        __props__["tags"] = tags
        __props__["timeout"] = timeout
        return LBICMPMonitor(resource_name, opts=opts, __props__=__props__)
