...
class LogicalPort(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, admin_state=None, description=None, display_name=None, logical_switch_id=None, switching_profile_ids=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a LogicalPort resource with the given unique name, props, and options.
        ...
        super(LogicalPort, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, admin_state=None, description=None, display_name=None, logical_switch_id=None, revision=None, switching_profile_ids=None, tags=None):
        """
        ...
        __props__["switching_profile_ids"] = switching_profile_ids
        __props__["tags"] = tags
        return LogicalPort(resource_name, opts=opts, __props__=__props__)
