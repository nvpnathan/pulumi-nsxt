...
class NSServiceGroup(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, members=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a NSServiceGroup resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[list] members: List of NSService or NSServiceGroup resources that can be added as members to an NSServiceGroup
        ...
        super(NSServiceGroup, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, description=None, display_name=None, members=None, revision=None, tags=None):
        """
        ...
        __props__["tags"] = tags
        return NSServiceGroup(resource_name, opts=opts, __props__=__props__)
