...
class PolicyDHCPRelay(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, nsx_id=None, server_addresses=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PolicyDHCPRelay resource with the given unique name, props, and options.
        ...
        super(PolicyDHCPRelay, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, description=None, display_name=None, nsx_id=None, path=None, revision=None, server_addresses=None, tags=None):
        """
        ...
        __props__["server_addresses"] = server_addresses
        __props__["tags"] = tags
        return PolicyDHCPRelay(resource_name, opts=opts, __props__=__props__)
