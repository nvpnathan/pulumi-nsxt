...
class PolicyGatewayPolicy(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, category=None, comments=None, description=None, display_name=None, domain=None, locked=None, nsx_id=None, rules=None, sequence_number=None, stateful=None, tags=None, tcp_strict=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PolicyGatewayPolicy resource with the given unique name, props, and options.
        ...
        super(PolicyGatewayPolicy, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, category=None, comments=None, description=None, display_name=None, domain=None, locked=None, nsx_id=None, path=None, revision=None, rules=None, sequence_number=None, stateful=None, tags=None, tcp_strict=None):
        """
        ...
        __props__["tags"] = tags
        __props__["tcp_strict"] = tcp_strict
        return PolicyGatewayPolicy(resource_name, opts=opts, __props__=__props__)
