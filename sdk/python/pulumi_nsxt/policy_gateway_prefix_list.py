...
class PolicyGatewayPrefixList(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, gateway_path=None, nsx_id=None, prefixes=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PolicyGatewayPrefixList resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[list] prefixes: Ordered list of network prefixes
        :param pulumi.Input[list] tags: Set of opaque identifiers meaningful to the user

        The **prefixes** object supports the following:

          * `action` (`pulumi.Input[str]`)
          * `ge` (`pulumi.Input[float]`)
          * `le` (`pulumi.Input[float]`)
        ...
        super(PolicyGatewayPrefixList, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, description=None, display_name=None, gateway_path=None, nsx_id=None, path=None, prefixes=None, revision=None, tags=None):
        """
        ...
        __props__["tags"] = tags
        return PolicyGatewayPrefixList(resource_name, opts=opts, __props__=__props__)
