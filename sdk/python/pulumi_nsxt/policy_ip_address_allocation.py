...
class PolicyIPAddressAllocation(pulumi.CustomResource):
    allocation_ip: pulumi.Output[str]
    """
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, allocation_ip=None, description=None, display_name=None, nsx_id=None, pool_path=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PolicyIPAddressAllocation resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] allocation_ip: The IP allocated. If unspecified any free IP will be allocated.
        ...
        :param pulumi.Input[str] pool_path: The path of the IP Pool for this allocation
        ...
        if opts.id is None:
            ...
            __props__['allocation_ip'] = allocation_ip
        ...
        super(PolicyIPAddressAllocation, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, allocation_ip=None, description=None, display_name=None, nsx_id=None, path=None, pool_path=None, revision=None, tags=None):
        """
        ...
        __props__["tags"] = tags
        return PolicyIPAddressAllocation(resource_name, opts=opts, __props__=__props__)
