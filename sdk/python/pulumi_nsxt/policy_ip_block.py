...
class PolicyIPBlock(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, cidr=None, description=None, display_name=None, nsx_id=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PolicyIPBlock resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] cidr: Network address and the prefix length which will be associated with a layer-2 broadcast domain
        ...
        super(PolicyIPBlock, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, cidr=None, description=None, display_name=None, nsx_id=None, path=None, revision=None, tags=None):
        """
        ...
        __props__["tags"] = tags
        return PolicyIPBlock(resource_name, opts=opts, __props__=__props__)
