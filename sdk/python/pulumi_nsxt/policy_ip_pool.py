...
class PolicyIPPool(pulumi.CustomResource):
    ...
    Set of opaque identifiers meaningful to the user
      ...
      * `tag` (`str`)
    """
    def __init__(__self__, resource_name, opts=None, description=None, display_name=None, nsx_id=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PolicyIPPool resource with the given unique name, props, and options.
        ...
        super(PolicyIPPool, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, description=None, display_name=None, nsx_id=None, path=None, revision=None, tags=None):
        """
        ...
        __props__["tags"] = tags
        return PolicyIPPool(resource_name, opts=opts, __props__=__props__)
