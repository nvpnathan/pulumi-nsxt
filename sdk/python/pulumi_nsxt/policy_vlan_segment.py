...
class PolicyVlanSegment(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, advanced_config=None, description=None, dhcp_config_path=None, discovery_profile=None, display_name=None, domain_name=None, l2_extension=None, nsx_id=None, qos_profile=None, security_profile=None, subnets=None, tags=None, transport_zone_path=None, vlan_ids=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PolicyVlanSegment resource with the given unique name, props, and options.
        ...
        super(PolicyVlanSegment, __self__).__init__(
    ...
    @staticmethod
    def get(resource_name, id, opts=None, advanced_config=None, description=None, dhcp_config_path=None, discovery_profile=None, display_name=None, domain_name=None, l2_extension=None, nsx_id=None, path=None, qos_profile=None, revision=None, security_profile=None, subnets=None, tags=None, transport_zone_path=None, vlan_ids=None):
        """
        ...
        __props__["transport_zone_path"] = transport_zone_path
        __props__["vlan_ids"] = vlan_ids
        return PolicyVlanSegment(resource_name, opts=opts, __props__=__props__)
